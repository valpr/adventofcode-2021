...
let initialRooms: apod[][] = [ // index 0 is the room A
    ['B','C'], // the first index is the deepest one, functions like stack
    ['C','B'],
    ['D','A'],
    ['A','D']
]
...
let practice: apod[][] = [ // index 0 is the room A
    ['A','B'], // the first index is the deepest one, functions like stack
    ['D','C'],
    ['C','B'],
    ['A','D']
]
...
const initialStateKey = createStateKey(initialHallway,practice)
solve(initialStateKey)
console.log('practice answer: 12521')
